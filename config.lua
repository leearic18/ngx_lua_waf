...
<body>
    <div class="cover">
        <h1>Stop visiting <small>Error 403</small></h1>
        <p class="lead">Sorry, the resources you visit are dangerous.</p>
    </div>
    
        <footer>
        <p>Technical Contact: <a href=mailto:supports@ddos.com>supports@ddos.com</a></p>
    </footer>
